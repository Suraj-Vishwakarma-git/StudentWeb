...
server.post("/addsubject", secure, async (req, res) => {
  ...
  const Usubject = await StudyPlan.create({
    userId: req.userId,
    subject: subject
  });
...
server.post("/subjecttopic", secure, async (req, res) => {
  ...
  const Utopic = await Subjecttopic.create({
    userId: req.userId,
    subjectId: subjectId,
    topic: topic
  });
...
server.post("/alltopics", secure, async (req, res) => {
  ...
  const topics = await Subjecttopic.find({
    subjectId: subjectId,
    userId: req.userId
  });
...
server.delete("/deletesubject", secure, async (req, res) => {
  ...
  const findsub = await StudyPlan.findOneAndDelete({
    userId: req.userId,
    _id: subjectId
  });
...
server.delete("/deleteexamdate", secure, async (req, res) => {
  ...
  const Delete = await ExamDate.deleteOne({
    userId: req.userId,
    _id: examId
  });
